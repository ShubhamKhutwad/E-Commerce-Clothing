...
const Store = () => {
    ...
    const fetchSearch = async (ser) =>{
        
        let route = `https://localhost:8443/api/v1/products/all?key=${ser}`;
        console.log(route);
        try {
    ...
    return (
        <div className="jumbotron">
            ...
            <Row>
                <input className="form-control mr-sm-2" type="search" placeholder="Search Deals" aria-label="Search" onChange={e => fetchSearch(e.target.value)} />
                <Col span={18}>
